encoding.py, image.py et pixel.py sont les scripts python utilisés pour l'implementation des differentes versions du format de compression d'images sans perte ULBMP.
